...
- Name: round-flow.spec.ts >> Round flow (3 holes) >> Hole 1: drive → approach → chip → sunk (par 4)
- Location: e2e/round-flow.spec.ts:32:7
...
Locator: getByText(/Hole 1 of 18/)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Hole 1 of 18/)
...
- main:
    - navigation:
        ...
        - link "Stats":
            - /url: /admin/stats
    - main:
        - heading "Tournaments" [level=1]
        - link "+ New tournament":
            - /url: /admin/tournaments/new
        - list:
            - listitem:
                - link "CIBC ARC Lionhead 2026":
                    - /url: /admin/tournaments/cibc-lionhead-2026
                - text: Lionhead Golf & Country Club· 6/22/2026· active
                - link "Edit":
